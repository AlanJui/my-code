...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/dashboard-nvim"
  },
  ["emmet-vim"] = {
    loaded = true,
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-scrollview"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/nvim-scrollview"
  },
  ["nvim-tree.lua"] = {
  ...
  ["one-nvim"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/one-nvim"
  },
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/onedark.vim"
  },
  ["open-browser.vim"] = {
    loaded = true,
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/popup.nvim"
  },
  ["tagalong.vim"] = {
    loaded = true,
  ...
  ["vim-solarized8"] = {
    loaded = true,
    path = "/home/alanjui/.local/share/nvim/site/pack/packer/start/vim-solarized8"
  },
  ["vim-surround"] = {
    loaded = true,
