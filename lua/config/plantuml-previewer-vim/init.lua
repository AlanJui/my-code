...
-- tocmd FileType plantuml let g:plantuml_previewer#plantuml_jar_path = '/Users/alanjui/.vim/autoload/plantuml.jar'
...
-- let g:plantuml_previewer#viewer_path = '/Users/alanjui/.vim/plugged/plantuml-previewer.vim/viewer/dist'
