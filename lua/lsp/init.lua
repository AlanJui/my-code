...
local on_attach = function(_, bufnr)
  ...
  -- vim.api.nvim_buf_set_keymap(bufnr, 'v', '<LocalLeader>ca', '<cmd>lua vim.lsp.buf.range_code_action()<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<LocalLeader>e', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', opts)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<LocalLeader>so', [[<cmd>lua require('telescope.builtin').lsp_document_symbols()<CR>]], opts)
